module.exports = function ( grunt ) {
  ...
  grunt.registerTask( 'watch', [ 'build', 'karma:unit', 'http-server', 'delta' ] );
  ...
  grunt.registerTask( 'build', [
    ...
    'copy:build_appjs', 'copy:build_vendorjs', 'copy:build_vendorcss', 'index:build', 'cacheBust:build',
  ...
  grunt.registerMultiTask( 'index', 'Process index.html template', function () {
    ...
    grunt.file.copy('src/app/service-worker.js', this.data.dir + '/service-worker.js');
  });
